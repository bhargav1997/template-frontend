            ...
            <Grid item xs={12} md={6}>
               <Box marginBottom={3}>
                  ...
                  <Typography component={"p"} color={"textSecondary"}>
                     Facilitating applied research and regional partnerships to respond to the health, economic, and environmental crises
                     brought about by the COVID-19 pandemic and climate change.
                  </Typography>
               </Box>
               <List disablePadding>
                  {[
                     {
                        ...
                        subtitle: (
                           <Typography fontSize='small'>
                              What effect will a revised 20/80 policy have on engaging and developing existing programming talent?
                           </Typography>
                        ),
                     },
                  ].map((item, index) => (
