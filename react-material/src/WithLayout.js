...
export const useDarkMode = () => {
   ...
   return [themeMode, themeToggler, paletteType, setThemePalette, mountedComponent];
};
...
export default function WithLayout({
   ...
   const [themeMode, themeToggler, paletteType, setThemePalette, mountedComponent] = useDarkMode();
   ...
   return (
      <ThemeProvider theme={getTheme(themeMode, paletteType)}>
         ...
         <CssBaseline />
         <Paper elevation={0}>
            <Layout themeMode={themeMode} themeToggler={themeToggler} paletteType={paletteType} setThemePalette={setThemePalette}>
