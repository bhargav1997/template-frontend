...
const Topbar = ({ themeMode, themeToggler, setThemePalette, onSidebarOpen, paletteType }) => {
   ...
   return (
      <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} width={"100%"}>
         ...
         <Box display='flex' alignItems={"center"}>
            <Box display={"flex"} padding={1} borderRadius={8} bgcolor={theme.palette.alternate.main}>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }} alignItems={"center"}>
               ...
               <Box marginX={2}>
                  <Link underline='none' component='a' href='/docs-introduction' color='textPrimary'>
                     Documentation
                  </Link>
               </Box>
            </Box>
